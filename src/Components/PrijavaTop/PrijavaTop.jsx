       ...
       <section id="prijava-top">
           <div className="prijava-image-wrapper">
            ...
            <div className="prijava-sadrzaj">
                <motion.div className="prijava-info" animate={{x: 0}} initial={{x: "-40rem"}} transition={{duration: 1}}>
                    <h1 className="prijava-title">Prijava</h1>
                    <div className="prijava-opis">
                        Sat brzo otkucava, požuri i prijavi se na ovogodišnji Hakaton za srednjoškolce.
