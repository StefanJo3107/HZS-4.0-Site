...
const TeamForm = (props) => {
  ...
  return (
    <div className="team-forma-container">
      <SectionTitle>podaci o timu</SectionTitle>
      <div className="row">
      ...
      <div className="row">
        ...
        <div className="col-75">
          ...
          >
            ...
            <option value={"preko-prijatelja"}>Preko prijatelja</option>
            <option value={"preko-profesora"}>Preko profesora</option>
            <option value={"preko-televizije"}>Preko televizije</option>
      ...
      <div className="row">
        <div className="col-25">
          <label for="staVasMotivise">
            Šta vas motiviše da se prijavite i šta bi za vas predstavljao uspeh
            na ovogodišnjem HZS-u?
          </label>
        </div>
        <div className="col-75">
          <motion.textarea
      ...
      {props.errors.pravilaTakmicenja && props.touched.pravilaTakmicenja ? (
