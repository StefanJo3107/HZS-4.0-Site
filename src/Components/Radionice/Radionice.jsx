...
const Radionice = () => {
  const radioniceContent = [
    ...
    },
    {
      ...
      slikaPredavaca: "https://avatars.githubusercontent.com/u/36775292?v=4",
      icons: [
  ...
  const radioniceWrapperStyle = {
    ...
    radioniceFixedBottom: { position: "absolute", bottom: "2rem" },
        ...
        >
          <div className="web-browser">
            ...
            <div className="radionica-content">
              <Radionica
                nazivRadionice={radioniceContent[slideIndex].nazivRadionice}
                opisRadionice={radioniceContent[slideIndex].opisRadionice}
                slikaPredavaca={radioniceContent[slideIndex].slikaPredavaca}
                imePredavaca={radioniceContent[slideIndex].imePredavaca}
                oPredavacu={radioniceContent[slideIndex].oPredavacu}
