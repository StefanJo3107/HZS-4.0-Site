        ...
        <div className="agenda" ref={props.section}>
            ...
            <div className="agenda-content">
                ...
                <AgendaItem
                    ...
                    opis="U drugom krugu selekcije timovi će raditi online test, čiji je cilj provera informatičkog znanja takmičara. Test se radi timski. Nakon testa, timove ćemo obavestiti o njihovim rezultatima i daljem prolasku."
                />
                <AgendaItem
