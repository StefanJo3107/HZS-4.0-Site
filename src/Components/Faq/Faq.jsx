  ...
  return (
    <div className="faq" ref={props.section}>
      ...
      <FaqItem
        ...
        answer={
          <p style={{ marginBottom: "1rem" }}>
            Na osnovu prijava sa sajta vrši se odabir timova koji će raditi
            online test. Cilj online testa jeste da se ispita informatičko
            znanje učesnika. Timovi koji ostvare najbolji rezultat u prva dva
            kruga selekcije prisustvovaće radionicama. Po završetku radionica
            učesnicima se zadaje domaći zadatak, koji ujedno predstavlja i treći
            krug selekcije. Na sam hakaton plasiraće se 8 do 10 timova koji se
            najbolje pokažu u sva tri kruga selekcije.
          </p>
        }
      />
      <FaqItem
